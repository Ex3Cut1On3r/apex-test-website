    ...
    <div className="settings-grid">
      <section className="setting-card">
        ...
        <ul className="setting-list">
          ...
          <li><span>English path</span><strong>{process.env.GITHUB_CONTENT_PATH_EN || "shared/content/en.json"}</strong></li>
          <li><span>Arabic path</span><strong>{process.env.GITHUB_CONTENT_PATH_AR || "shared/content/ar.json"}</strong></li>
        </ul>
      </section>
      ...
      <section className="setting-card">
        ...
        <p>Before exposing the portal on a real subdomain, configure all secrets and restrict repository access to the minimum required scope.</p>
        <ul className="setting-list">
          ...
          <li><span>4</span><strong>Deploy to cms.your-domain</strong></li>
        </ul>
      </section>
    </div>
  );
