...
import { Icon, type AdminIconName } from "./ap_admin_icons";
      ...
      <div className="admin-main">
        <header className="admin-topbar">
          ...
          <div className="top-actions">
            ...
            <a className="ap-button ap-button-soft" href={process.env.NEXT_PUBLIC_APEX_SITE_URL || "/"} target="_blank" rel="noreferrer">Preview site <Icon name="external" /></a>
          </div>
        </header>
